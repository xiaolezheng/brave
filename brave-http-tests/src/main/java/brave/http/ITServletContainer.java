...
public abstract class ITServletContainer extends ITHttpServer {
  ...
  @Override protected final void init(Tracing tracing, @Nullable Supplier<String> spanName) {
    stop();
  ...
  public abstract void init(ServletContextHandler handler, Tracing tracing,
